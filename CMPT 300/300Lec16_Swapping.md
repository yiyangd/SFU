...
We use a page size of 2<sup>N</sup>, typically varying between 4KB and 1GB per page, depending on computer architecture.
- Displacement: **least significant N bits** of logical address ( N-1 to 0)
- Page Number: Remaining most **significant bits**
![paging hardware](imgs/paging_hardware.jpeg)

#### Paging Example:
Consider main memory with 32 memory locations (words)
- Page size of 4 words

What is the physical memory address size?
- 5 Bits
